                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>&nbsp <b><?php echo $donnees ['nom'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $donnees ['adresse'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $donnees ['cin'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $donnees ['telephone'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $donnees ['email'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $donnees ['pass_word'];?>&nbsp </b></td>
                                                <td>&nbsp <b><a href="modifclient.php?idPersonne=<?php echo $donnees ['id'];?>" class="btn btn-success btn-circle btn-sm">
                    <i class="fas fa-check"></i>
                  </a> 

<a href="supprimclient.php?idPersonne=<?php echo $donnees ['id'];?>"  class="btn btn-danger btn-circle btn-sm">
