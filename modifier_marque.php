                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group" row>
                                        <input type="hidden" name="id" value="<?php echo($result->marque_id) ;?>">
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" value="<?php echo($result->marque_nom) ;?>" name="nom">
                                        </div>
                                    </div>
...
if (isset($_POST['b1'])) {
       ...
       $nom = $_POST["nom"] ;
       $id= $_POST["id"];
   $insert_marque = "UPDATE  marque SET marque_nom='$nom' where marque_id ='$id'";
