...
if (isset($_POST['b1'])) {
   ...
   $insert_cat = "INSERT into categorie (cat_title) values ('$nom')";
                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom Sous-Catégorie:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname"  name="nom">
                                        </div>
                                    </div>
...
if (isset($_POST['b2'])) {
   ...
   $insert_souscat = "INSERT into sous_categorie (sous_cat_title) values ('$nom')";
    $insert_pro = mysqli_query ($con ,$insert_souscat);
    if ($insert_pro) {
    header('Location: listecat.php');
    }
